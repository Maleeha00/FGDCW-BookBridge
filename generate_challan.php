...
// Get fine_id from URL and validate
...
$sql = "
    SELECT 
        ...
        b.book_name,
        u.name as student_name, u.unique_id as student_roll_no, u.department as student_class
    FROM fines f
...
<title>Bookbridge Fine Challan</title>
 ...
 body { font-family: Arial, sans-serif; margin: 0; padding: 20px; background-color: #f0f0f0; }
    ...
    .page-actions {
        ...
        z-index: 1000;
        display: flex;
        justify-content: space-between; /* Is se aik left aur aik right par chala jayega */
    }
    ...
    /* Print ke waqt ki styling */
    @media print {
        /* ... aap ka baaqi ka print style ... */
        .page-actions {
            display: none;
        }
    }
        ...
        @media print {
            ...
            /* Print ke waqt in cheezon ko hide kar dein */
            .print-actions {
                display: none;
            }
        }
