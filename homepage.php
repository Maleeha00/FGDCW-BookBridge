...
<head>
  ...
  <style>
    ...
    /*box k bahir wala effect*/
      {
      background: #fff;
      border-radius: 10px;
      padding: 40px;
      box-shadow: 0 0 15px #8d4444d1;
    }

    .section-header

    /*get in touch wali div*/
      {
      display: flex;
      align-items: center;
      gap: 15px;
    ...
    .section-icon {
      width: 60px;
      height: 60px;
      background: linear-gradient(#2d8b6cab 0%, #00326ac5 100%);
      border-radius: 50%;
      display: flex;
      align-items: center;
...
<body>
        ...
        <div class="section-content">
          ...
          <div class="contact-info">
            ...
            <div class="contact-items">
              ...
              <div class="contact-item">
                <div class="contact-icon"><i class="fa-solid fa-phone-flip"></i></div>
                <div class="contact-details">
                  <h4>Phone</h4>
                  <p>(053) 9240102</p>
                </div>
  ...
  <footer>
    ...
    FGDCW BookBridge | Made with ❤ by <b>Aqsa Hakeem, Maleeha and Iqra Noureen (BSIT)</b>
  </footer>

  <script>
    function showLoginPrompt() {
      if (confirm("Kindly login to access library resources.")) {
