...
// Step 1: Sab se pehle error reporting on karein
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);

// Step 2: Config file include karein
include_once '../includes/config.php';

// Step 3: Log file ka path theek se set karein
$log_file = __DIR__ . '/payfast_log.txt'; // __DIR__ se aage ghalti nahi hogi

// Step 4: Log file mein likhne ki koshish karein
$initial_log = file_put_contents($log_file, "--- New ITN Request ---\n" . date('Y-m-d H:i:s') . "\n", FILE_APPEND);

if ($initial_log === false) {
    // Agar file nahi ban saki to foran error de kar ruk jayein
...
// Step 5: Database Connection Dobara Banayein (sirf is file ke liye)
...
if ($conn->connect_error) {
    ...
    die("DB Connection Error"); // Script rok dein
}

// === Baaqi ka code pehle jaisa hi hai ===
